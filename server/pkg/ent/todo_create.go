...
func (tc *TodoCreate) SetStartAt(t time.Time) *TodoCreate {
	tc.mutation.SetStartAt(t)
	return tc
}

// SetEndAt sets the "end_at" field.
func (tc *TodoCreate) SetEndAt(t time.Time) *TodoCreate {
	tc.mutation.SetEndAt(t)
	return tc
}
...
func (tc *TodoCreate) createSpec() (*Todo, *sqlgraph.CreateSpec) {
	...
	if value, ok := tc.mutation.EndAt(); ok {
